  ...
  init: function () {
    ...
    $("." + k + "-fx").each(function (i) {
      ...
      if (c.indexOf(" " + k + "-accordion") != -1)
        $exeFX.accordion.init(this, i);
      else if (c.indexOf(" " + k + "-tabs") != -1) $exeFX.tabs.init(this, i);
      else if (c.indexOf(" " + k + "-paginated") != -1)
        $exeFX.paginated.init(this, i);
      else if (c.indexOf(" " + k + "-carousel") != -1)
        $exeFX.carousel.init(this, i);
      else if (
        c.indexOf(" " + k + "-timeline") != -1 &&
        document.body.className.indexOf("exe-epub3") != 0
      ) {
  ...
  accordion: {
      ...
      if (title.length == 1) {
        ...
        if (typeof color == "string") {
          ...
          if (color.indexOf("rgba(") == 0)
            x.css("box-shadow", "0px 1px 3px " + color);
    ...
    rft: function (e, i) {
      ...
      $(".fx-accordion-content", e).each(function (y) {
        ...
        this.id = id;
        h2.eq(y).wrap(
          '<a class="fx-accordion-title fx-accordion-title-' +
            y +
            ' fx-C1" href="#' +
            id +
            '" id="' +
    ...
    rft: function (e, i) {
          ...
          if (part2.length == 2) {
            ...
            if (p2.length == 1 || p2.length == 0) {
              ...
              if (oldB) {
                ...
                partContent = partContent.replace(
                  /\<H3>/g,
                  '</div>\n<h3 class="fx-timeline-event-trigger"><a href="#" style="color:' +
                    mainColor +
                    '">'
                );
              } else {
              ...
              partContent += "</div>";
              partContent =
                '<div class="fx-timeline-major">\n<h2 class="fx-timeline-marker"><span><a href="#" style="background:' +
                mainColor +
                '">' +
                partTitle +
      ...
      if (html != "") {
        ...
        if (!isNaN(parseFloat(ie)) && isFinite(ie) && ie < 8) {
          ...
          e.html(
            '<div class="fx-timeline-toggler"><p><a href="#" class="fx-timeline-expand" style="background-color:' +
              mainColor +
              ";color:" +
              titlesColor +
              '">' +
      ...
      if (oldB == false) {
        var css =
          ...
          gID +
          " .fx-timeline-major h3:before{color:" +
          mainColor +
          "}</style>";
        $("HEAD").append(css);
      }
  ...
  paginated: {
    ...
    rft: function (e, i) {
      ...
      ul +=
        ...
        "-paginated-" +
        i +
        '-prev" class="fx-prev-next fx-prev fx-disabled"><a href="#" id="' +
        k +
        "-paginated-" +
        i +
        '-prev-lnk" title="' +
        $exe_i18n.previous +
        '" onclick="return false"><span>&#9668;</span></a></li>';
      ...
      ul +=
        ...
        "-paginated-" +
        i +
        '-next" class="fx-prev-next fx-next';
  ...
  carousel: {
    ...
    rft: function (e, i) {
      ...
      ul +=
        ...
        "-carousel-" +
        i +
        '-prev" class="fx-carousel-prev-next fx-carousel-prev fx-disabled fx-C2"><a href="#" id="exe-carousel-' +
        i +
        '-prev-lnk" title="' +
        $exe_i18n.previous +
        '" onclick="return false"><span>&#9668;</span></a></li>';
      ...
      ul +=
        ...
        "-carousel-" +
        i +
        '-next" class="fx-carousel-prev-next fx-carousel-next fx-C2';
      if (!hasNext) ul += " fx-disabled";
      ul +=
        '"><a href="#" id="' +
        k +
...
(function (e) {
  ...
  e.timeliner = function (n) {
    t = jQuery.extend(
      {
        timelineContainer: ".fx-timeline-container",
        startState: "closed",
        startOpen: [],
        baseSpeed: 100,
        speed: 4,
        fontOpen: "1.1em",
        fontClosed: "1em",
        expandAllText: $exe_i18n.show,
        collapseAllText: $exe_i18n.hide,
      },
      n
    );
    e(document).ready(function () {
      function n(n, r) {
        e(n)
          .removeClass("closed")
          .addClass("open")
          .animate({ fontSize: t.fontOpen }, t.baseSpeed);
        e(r).show(t.speed * t.baseSpeed);
      }
      function r(n, r) {
        e(n)
          .animate({ fontSize: t.fontClosed }, 0)
          .removeClass("open")
          .addClass("closed");
        e(r).hide(t.speed * t.baseSpeed);
      }
      if (t.startState === "closed") {
        e(".fx-timeline-event").hide();
        e.each(e(t.startOpen), function (t, r) {
          n(e(r).parent(".fx-timeline-minor").find("h3 a"), e(r));
        });
      } else {
        n(e(".fx-timeline-minor h3 a"), e(".fx-timeline-event"));
      }
      e(t.timelineContainer).on("click", ".fx-timeline-minor h3", function () {
      ...
      e(t.timelineContainer).on("click", ".fx-timeline-marker", function () {
        var t = e(this)
          .parents(".fx-timeline-major")
          .find(".fx-timeline-minor").length;
        var i = e(this).parents(".fx-timeline-major").find(".open").length;
        if (t > i) {
          n(
            e(this)
              .parents(".fx-timeline-major")
              .find("h3 a", ".fx-timeline-minor"),
            e(this).parents(".fx-timeline-major").find(".fx-timeline-event")
          );
        } else {
          r(
            e(this).parents(".fx-timeline-major").find(".fx-timeline-minor a"),
            e(this).parents(".fx-timeline-major").find(".fx-timeline-event")
          );
        }
        return false;
      });
      e(".fx-timeline-expand").click(function () {
        if (e(this).hasClass("expanded")) {
          r(
            e(this)
              .parents(t.timelineContainer)
              .find("h3 a", ".fx-timeline-minor"),
            e(this).parents(t.timelineContainer).find(".fx-timeline-event")
          );
